<footer>
    <div class="wrapper">
        ...
        <div class="half">
            <ul>
                ...
                <li><a href="/about/teacher-registration">Teacher Registration</a></li>
            </ul>
        </div>
	...
	<ul>
		<!--nothinghere-->
            ...
            <a href="https://twitter.com/projectexplorer"><img class="social" src="/img/icon-twitter.png" alt="Twitter" /></a>
            <a href="http://vimeo.com/projectexplorer"><img class="social" src="/img/icon-vimeo.png" alt="Vimeo" /></a>
        </div>
        <hr class="clearfix" />
    </div>
</footer>
